...
public class SimpleCalculator {
    ...
    /**
     * Muchachos este es el ejercicio 4 que tenia que hacer igual todavia no esta funcionando al 100%,
     * faltan algunas cosas, igual ya anda para operaciones como "2+3*5-6/2="  si quieren probarlo tienen
     * que escribirlo por consola y no se olviden de poner el simbolo igual (=) al final. Cuando vuelva de la
     * facu lo termino bien.
     */
